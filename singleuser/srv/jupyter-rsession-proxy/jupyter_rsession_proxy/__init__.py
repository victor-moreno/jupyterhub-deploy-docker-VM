    ...
    for header, v in response.headers.get_all():
        if header == "Location":
            ...
            if ", " in urlparse(v).netloc:
                ...
                if v.endswith("auth-sign-in"):
                    u = u._replace(path=u.path.replace("/rstudio/auth-sign-in","/lab"))
                if v.endswith("auth-sign-out"):
                    u = u._replace(path=u.path.replace("/rstudio/auth-sign-out","/lab"))                    
